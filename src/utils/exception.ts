...
export const errorHandler = (hono: Hono<BlankEnv, BlankSchema, "/api">) => {
  return hono.onError((err: Error | HTTPException, c: Context) => {
...
export const notFoundHandler = (hono: Hono<BlankEnv, BlankSchema, "/api">) => {
  return hono.notFound((c: Context) => {
